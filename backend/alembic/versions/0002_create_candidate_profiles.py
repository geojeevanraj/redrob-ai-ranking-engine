...
Revision ID: 0002_create_candidate_profiles
...
revision: str = "0002_create_candidate_profiles"
...
def downgrade() -> None:
    op.drop_index(op.f("ix_candidate_profiles_document_id"), table_name="candidate_profiles")
