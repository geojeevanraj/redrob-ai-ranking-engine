...
The full structured `CandidateProfile` is stored as JSONB; a few fields are
promoted to columns for cheap querying/listing.
"""
...
class CandidateProfileRecord(Base):
    """A structured candidate profile derived from a document."""
